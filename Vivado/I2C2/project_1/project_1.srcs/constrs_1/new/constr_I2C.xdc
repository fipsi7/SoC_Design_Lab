...
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W5 [get_ports {sout_0}];  # "JD1_N"
set_property PACKAGE_PIN W6 [get_ports {sin_0}];  # "JD1_P"
set_property PACKAGE_PIN W7 [get_ports {iic_rtl_sda_io}];  # "nix"
set_property -dict { PACKAGE_PIN W7     IOSTANDARD LVCMOS33 } [get_ports { iic_rtl_sda_io } ];
set_property drive 15 [get_ports { iic_rtl_sda_io } ];
set_property pullup TRUE [get_ports { iic_rtl_sda_io } ];
set_property PACKAGE_PIN V7 [get_ports {iic_rtl_scl_io}];  # "nix"
set_property -dict { PACKAGE_PIN V7     IOSTANDARD LVCMOS33 } [get_ports { iic_rtl_scl_io } ];
set_property drive 15 [get_ports { iic_rtl_scl_io } ];
